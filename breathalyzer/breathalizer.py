...
def number_of_changes(word1, word2):
    "Calculates the number of changes from word1 to word2"
    if word1 == word2:
        return 0 
...
wall_post_words = [l.rstrip().split(" ") for l in wall_post.readlines()]

# List of Accepted Words
accepted_words_file = open('twl06.txt', 'r')
accepted_words = [l.rstrip() for l in accepted_words_file.readlines()]

# Calculate the smallest ammount of changes necessary
total_of_changes = 0
